	...
	<div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
	  ...
	  <div class="grid sm:grid-cols-2 gap-6">
		...
		<a href="#" class="group h-80 flex items-end bg-gray-100 rounded-lg overflow-hidden shadow-lg relative p-4">
		  <img src="https://images.unsplash.com/photo-1620243318482-fdd2affd7a38?auto=format&q=75&fit=crop&w=750" loading="lazy" alt="Photo by Fakurian Design" class="w-full h-full object-cover object-center absolute inset-0 transform group-hover:scale-110 transition duration-200" />
		...
		<!-- product - start -->
		<a href="#" class="group h-80 flex items-end bg-gray-100 rounded-lg overflow-hidden shadow-lg relative p-4">
		  <img src="https://images.unsplash.com/photo-1620241608701-94ef138c7ec9?auto=format&q=75&fit=crop&w=750" loading="lazy" alt="Photo by Fakurian Design" class="w-full h-full object-cover object-center absolute inset-0 transform group-hover:scale-110 transition duration-200" />
    ...
    <div class="grid sm:grid-cols-2 gap-4 md:gap-8">
      ...
      <div class="bg-gray-100 rounded-lg p-5">
        <div class="flex justify-between items-center border-b gap-4 pb-4 mb-4">
          ...
          <span class="w-8 h-8 inline-flex justify-center items-center flex-shrink-0 bg-gray-300 text-gray-500 rounded-full">
